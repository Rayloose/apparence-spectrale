...
start_number = 23 #là où il faut commencer à prendre la longueur d'onde
end_number = 24 #fin du string
final_dico = {}
...
for i in range(1,9):
    ...
    with open(filename, mode='w', newline="") as file:
        ...
        writer.writerows(final_dico[str(i)][2])
        print(final_dico[str(i)][0])

        if i == 1:
            print(final_dico[str(i)][2])
#
